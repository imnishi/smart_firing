...
"""autogenerated by genpy from roborts_msgs/GlobalPlannerActionResult.msg. Do not edit."""
import codecs
import sys
...
class GlobalPlannerActionResult(genpy.Message):
  ...
  _type = "roborts_msgs/GlobalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roborts_msgs/GlobalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = roborts_msgs.msg.GlobalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roborts_msgs.msg.GlobalPlannerResult()
