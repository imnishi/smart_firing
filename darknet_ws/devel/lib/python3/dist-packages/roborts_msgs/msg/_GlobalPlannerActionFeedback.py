...
"""autogenerated by genpy from roborts_msgs/GlobalPlannerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GlobalPlannerActionFeedback(genpy.Message):
  ...
  _type = "roborts_msgs/GlobalPlannerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roborts_msgs/GlobalPlannerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = roborts_msgs.msg.GlobalPlannerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = roborts_msgs.msg.GlobalPlannerFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.path.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.error_msg = str[start:end].decode('utf-8', 'rosmsg')
      else:
