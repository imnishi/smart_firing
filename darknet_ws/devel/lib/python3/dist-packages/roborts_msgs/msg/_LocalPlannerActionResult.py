...
"""autogenerated by genpy from roborts_msgs/LocalPlannerActionResult.msg. Do not edit."""
import codecs
import sys
...
class LocalPlannerActionResult(genpy.Message):
  ...
  _type = "roborts_msgs/LocalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roborts_msgs/LocalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = roborts_msgs.msg.LocalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roborts_msgs.msg.LocalPlannerResult()
