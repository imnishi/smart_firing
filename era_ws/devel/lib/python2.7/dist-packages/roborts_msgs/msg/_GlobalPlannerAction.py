...
"""autogenerated by genpy from roborts_msgs/GlobalPlannerAction.msg. Do not edit."""
import codecs
import sys
...
class GlobalPlannerAction(genpy.Message):
  ...
  _type = "roborts_msgs/GlobalPlannerAction"
...
"""
  ...
  _slot_types = ['roborts_msgs/GlobalPlannerActionGoal','roborts_msgs/GlobalPlannerActionResult','roborts_msgs/GlobalPlannerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = roborts_msgs.msg.GlobalPlannerActionGoal()
      if self.action_result is None:
        self.action_result = roborts_msgs.msg.GlobalPlannerActionResult()
      if self.action_feedback is None:
        self.action_feedback = roborts_msgs.msg.GlobalPlannerActionFeedback()
    else:
      self.action_goal = roborts_msgs.msg.GlobalPlannerActionGoal()
      self.action_result = roborts_msgs.msg.GlobalPlannerActionResult()
      self.action_feedback = roborts_msgs.msg.GlobalPlannerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_feedback.feedback.error_code
      buff.write(_get_struct_i().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_feedback.feedback.path.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.error_msg = str[start:end].decode('utf-8', 'rosmsg')
      else:
