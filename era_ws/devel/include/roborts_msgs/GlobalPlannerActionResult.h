...
bool operator==(const ::roborts_msgs::GlobalPlannerActionResult_<ContainerAllocator1> & lhs, const ::roborts_msgs::GlobalPlannerActionResult_<ContainerAllocator2> & rhs)
{
