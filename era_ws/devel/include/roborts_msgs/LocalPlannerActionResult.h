...
bool operator==(const ::roborts_msgs::LocalPlannerActionResult_<ContainerAllocator1> & lhs, const ::roborts_msgs::LocalPlannerActionResult_<ContainerAllocator2> & rhs)
{
